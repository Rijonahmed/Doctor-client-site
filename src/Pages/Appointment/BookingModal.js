      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center mt-3'>
            ...
            <input type="text" name='name' placeholder="Your Nmae" className="input input-bordered input-accent w-full max-w-xs" />
            <input type="email" name='email' placeholder="Your Email" className="input input-bordered input-accent w-full max-w-xs" />
